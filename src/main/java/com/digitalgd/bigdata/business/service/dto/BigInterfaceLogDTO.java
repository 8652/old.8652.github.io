...
public class BigInterfaceLogDTO implements Serializable {
    ...
    @NotNull
    @Size(max = 40)
    @ApiModelProperty(value = "应用接入账号", required = true)
    ...
    @NotNull
    @Size(max = 300)
    @ApiModelProperty(value = "本地接口路径", required = true)
     ...
     */
    @Size(max = 300)
    @ApiModelProperty(value = "数据提供方编码（列表，以逗号间隔）")
     ...
     */
    @Size(max = 300)
    @ApiModelProperty(value = "数据提供方名称（列表，以逗号间隔）")
    private String dataProvNamess;
    ...
    @NotNull
    @Size(max = 10)
    @ApiModelProperty(value = "接口调用状态", required = true)
    ...
    public String getDataProvNamess() {
        return dataProvNamess;
    }

    public void setDataProvNamess(String dataProvNamess) {
        this.dataProvNamess = dataProvNamess;
    }
    ...
    public String toString() {
        return "BigInterfaceLogDTO{" +
            ...
            ", dataProvNamess='" + getDataProvNamess() + "'" +
            ", useTime='" + getUseTime() + "'" +
            ", status='" + getStatus() + "'" +
