...
public class BigInterfaceLog implements Serializable {
    ...
    @NotNull
    @Size(max = 300)
    @Column(name = "interface_path", length = 300, nullable = false)
     ...
     */
    @Size(max = 300)
    @Column(name = "data_prov_ids", length = 300)
     ...
     */
    @Size(max = 300)
    @Column(name = "data_prov_namess", length = 300)
    ...
    public BigInterfaceLog dataProvNamess(String dataProvNamess) {
