...
public class PairContract implements Serializable {
    ...
    @NotNull
    @Size(max = 6)
    @Column(name = "contact_code", length = 6, nullable = false)
     ...
     */
    @Size(max = 500)
    @Column(name = "contact_desc", length = 500)
    ...
    public PairContract contactName(String contactName) {
    ...
    public PairContract contactCode(String contactCode) {
    ...
    public PairContract contactStatus(String contactStatus) {
    ...
    public PairContract contactDesc(String contactDesc) {
