...
public class BizItemResourceIT {
    ...
    public void createBizItem() throws Exception {
        ...
        assertThat(testBizItem.getPkid()).isEqualTo(DEFAULT_PKID);
        ...
        assertThat(testBizItem.getPairContractId()).isEqualTo(DEFAULT_PAIR_CONTRACT_ID);
    ...
    public void checkPairContractIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = bizItemRepository.findAll().size();
        // set the field null
        bizItem.setPairContractId(null);
    ...
    public void updateBizItem() throws Exception {
        ...
        BizItem testBizItem = bizItemList.get(bizItemList.size() - 1);
        assertThat(testBizItem.getPkid()).isEqualTo(UPDATED_PKID);
        ...
        assertThat(testBizItem.getPairContractId()).isEqualTo(UPDATED_PAIR_CONTRACT_ID);
