...
public class PairContractFileResourceIT {
    ...
    public void createPairContractFile() throws Exception {
        ...
        assertThat(testPairContractFile.getFileId()).isEqualTo(DEFAULT_FILE_ID);
        assertThat(testPairContractFile.getFileType()).isEqualTo(DEFAULT_FILE_TYPE);
    ...
    public void updatePairContractFile() throws Exception {
        ...
        assertThat(testPairContractFile.getFileId()).isEqualTo(UPDATED_FILE_ID);
        assertThat(testPairContractFile.getFileType()).isEqualTo(UPDATED_FILE_TYPE);
