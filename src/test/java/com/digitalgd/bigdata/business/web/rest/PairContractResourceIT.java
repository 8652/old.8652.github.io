...
public class PairContractResourceIT {
    ...
    private static final String DEFAULT_CONTACT_CODE = "AAAAAA";
    private static final String UPDATED_CONTACT_CODE = "BBBBBB";

    private static final String DEFAULT_CONTACT_STATUS = "AAAAAAAAAA";
    private static final String UPDATED_CONTACT_STATUS = "BBBBBBBBBB";

    private static final String DEFAULT_CONTACT_DESC = "AAAAAAAAAA";
    private static final String UPDATED_CONTACT_DESC = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_CONSUMER_ACCOUNT = "AAAAAAAAAA";
    private static final String UPDATED_CONSUMER_ACCOUNT = "BBBBBBBBBB";
    ...
    public static PairContract createEntity(EntityManager em) {
        PairContract pairContract = new PairContract()
            ...
            .contactDesc(DEFAULT_CONTACT_DESC)
            ...
            .consumerAccount(DEFAULT_CONSUMER_ACCOUNT)
    ...
    public static PairContract createUpdatedEntity(EntityManager em) {
        PairContract pairContract = new PairContract()
            ...
            .contactDesc(UPDATED_CONTACT_DESC)
            ...
            .consumerAccount(UPDATED_CONSUMER_ACCOUNT)
    ...
    public void createPairContract() throws Exception {
        ...
        assertThat(testPairContract.getContactName()).isEqualTo(DEFAULT_CONTACT_NAME);
        assertThat(testPairContract.getContactCode()).isEqualTo(DEFAULT_CONTACT_CODE);
        assertThat(testPairContract.getContactStatus()).isEqualTo(DEFAULT_CONTACT_STATUS);
        assertThat(testPairContract.getContactDesc()).isEqualTo(DEFAULT_CONTACT_DESC);
        ...
        assertThat(testPairContract.getConsumerAccount()).isEqualTo(DEFAULT_CONSUMER_ACCOUNT);
    ...
    public void checkContactNameIsRequired() throws Exception {
        ...
        // set the field null
        pairContract.setContactName(null);
    ...
    public void checkContactCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = pairContractRepository.findAll().size();
        // set the field null
        pairContract.setContactCode(null);
    ...
    @Test
    @Transactional
    public void checkContactStatusIsRequired() throws Exception {
        int databaseSizeBeforeTest = pairContractRepository.findAll().size();
        // set the field null
        pairContract.setContactStatus(null);
    ...
    public void getAllPairContracts() throws Exception {
        ...
        restPairContractMockMvc.perform(get("/api/pair-contracts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].contactCode").value(hasItem(DEFAULT_CONTACT_CODE)))
            .andExpect(jsonPath("$.[*].contactStatus").value(hasItem(DEFAULT_CONTACT_STATUS)))
            .andExpect(jsonPath("$.[*].contactDesc").value(hasItem(DEFAULT_CONTACT_DESC)))
            ...
            .andExpect(jsonPath("$.[*].consumerAccount").value(hasItem(DEFAULT_CONSUMER_ACCOUNT)))
    ...
    public void getPairContract() throws Exception {
        ...
        restPairContractMockMvc.perform(get("/api/pair-contracts/{id}", pairContract.getId()))
            ...
            .andExpect(jsonPath("$.contactCode").value(DEFAULT_CONTACT_CODE))
            .andExpect(jsonPath("$.contactStatus").value(DEFAULT_CONTACT_STATUS))
            .andExpect(jsonPath("$.contactDesc").value(DEFAULT_CONTACT_DESC))
            ...
            .andExpect(jsonPath("$.consumerAccount").value(DEFAULT_CONSUMER_ACCOUNT))
    ...
    public void updatePairContract() throws Exception {
        ...
        PairContract testPairContract = pairContractList.get(pairContractList.size() - 1);
        assertThat(testPairContract.getContactName()).isEqualTo(UPDATED_CONTACT_NAME);
        assertThat(testPairContract.getContactCode()).isEqualTo(UPDATED_CONTACT_CODE);
        assertThat(testPairContract.getContactStatus()).isEqualTo(UPDATED_CONTACT_STATUS);
        assertThat(testPairContract.getContactDesc()).isEqualTo(UPDATED_CONTACT_DESC);
        ...
        assertThat(testPairContract.getConsumerAccount()).isEqualTo(UPDATED_CONSUMER_ACCOUNT);
