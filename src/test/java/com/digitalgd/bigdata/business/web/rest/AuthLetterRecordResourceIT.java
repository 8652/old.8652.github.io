...
public class AuthLetterRecordResourceIT {
    ...
    public void createAuthLetterRecord() throws Exception {
        ...
        assertThat(testAuthLetterRecord.getPairContactId()).isEqualTo(DEFAULT_PAIR_CONTACT_ID);
        assertThat(testAuthLetterRecord.getPairContactName()).isEqualTo(DEFAULT_PAIR_CONTACT_NAME);
    ...
    public void checkPairContactIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = authLetterRecordRepository.findAll().size();
        // set the field null
        authLetterRecord.setPairContactId(null);
    ...
    public void checkPairContactNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = authLetterRecordRepository.findAll().size();
        // set the field null
        authLetterRecord.setPairContactName(null);
    ...
    public void updateAuthLetterRecord() throws Exception {
        ...
        assertThat(testAuthLetterRecord.getPairContactId()).isEqualTo(UPDATED_PAIR_CONTACT_ID);
        assertThat(testAuthLetterRecord.getPairContactName()).isEqualTo(UPDATED_PAIR_CONTACT_NAME);
