...
public class AuthLetterRecordResourceIT {
    ...
    public void createAuthLetterRecord() throws Exception {
        ...
        assertThat(testAuthLetterRecord.getGlobalUniqueId()).isEqualTo(DEFAULT_GLOBAL_UNIQUE_ID);
        ...
        assertThat(testAuthLetterRecord.getFileId()).isEqualTo(DEFAULT_FILE_ID);
        ...
        assertThat(testAuthLetterRecord.getAppKey()).isEqualTo(DEFAULT_APP_KEY);
    ...
    @Test
    @Transactional
    public void checkGlobalUniqueIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = authLetterRecordRepository.findAll().size();
        // set the field null
        authLetterRecord.setGlobalUniqueId(null);
    ...
    public void updateAuthLetterRecord() throws Exception {
        ...
        AuthLetterRecord testAuthLetterRecord = authLetterRecordList.get(authLetterRecordList.size() - 1);
        assertThat(testAuthLetterRecord.getGlobalUniqueId()).isEqualTo(UPDATED_GLOBAL_UNIQUE_ID);
        ...
        assertThat(testAuthLetterRecord.getFileId()).isEqualTo(UPDATED_FILE_ID);
        ...
        assertThat(testAuthLetterRecord.getAppKey()).isEqualTo(UPDATED_APP_KEY);
