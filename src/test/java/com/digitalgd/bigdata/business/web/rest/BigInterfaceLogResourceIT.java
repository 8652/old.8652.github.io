...
public class BigInterfaceLogResourceIT {
    ...
    private static final String DEFAULT_DATA_PROV_NAMESS = "AAAAAAAAAA";
    private static final String UPDATED_DATA_PROV_NAMESS = "BBBBBBBBBB";
    ...
    public static BigInterfaceLog createEntity(EntityManager em) {
        BigInterfaceLog bigInterfaceLog = new BigInterfaceLog()
            ...
            .dataProvNamess(DEFAULT_DATA_PROV_NAMESS)
    ...
    public static BigInterfaceLog createUpdatedEntity(EntityManager em) {
        BigInterfaceLog bigInterfaceLog = new BigInterfaceLog()
            ...
            .dataProvNamess(UPDATED_DATA_PROV_NAMESS)
    ...
    public void createBigInterfaceLog() throws Exception {
        ...
        assertThat(testBigInterfaceLog.getDataProvNamess()).isEqualTo(DEFAULT_DATA_PROV_NAMESS);
    ...
    public void checkAppKeyIsRequired() throws Exception {
        ...
        // set the field null
        bigInterfaceLog.setAppKey(null);
    ...
    @Test
    @Transactional
    public void checkInterfacePathIsRequired() throws Exception {
        int databaseSizeBeforeTest = bigInterfaceLogRepository.findAll().size();
        // set the field null
        bigInterfaceLog.setInterfacePath(null);
    ...
    public void checkStatusIsRequired() throws Exception {
        int databaseSizeBeforeTest = bigInterfaceLogRepository.findAll().size();
        // set the field null
        bigInterfaceLog.setStatus(null);
    ...
    public void getAllBigInterfaceLogs() throws Exception {
        ...
        restBigInterfaceLogMockMvc.perform(get("/api/big-interface-logs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dataProvNamess").value(hasItem(DEFAULT_DATA_PROV_NAMESS)))
    ...
    public void getBigInterfaceLog() throws Exception {
        ...
        restBigInterfaceLogMockMvc.perform(get("/api/big-interface-logs/{id}", bigInterfaceLog.getId()))
            ...
            .andExpect(jsonPath("$.dataProvNamess").value(DEFAULT_DATA_PROV_NAMESS))
    ...
    public void updateBigInterfaceLog() throws Exception {
        ...
        assertThat(testBigInterfaceLog.getDataProvNamess()).isEqualTo(UPDATED_DATA_PROV_NAMESS);
