...
public class AuthLetterTemplateResourceIT {
    ...
    private static final String DEFAULT_PAIR_CONTACT_NAME = "AAAAAAAAAA";
    private static final String UPDATED_PAIR_CONTACT_NAME = "BBBBBBBBBB";
    ...
    public static AuthLetterTemplate createEntity(EntityManager em) {
        AuthLetterTemplate authLetterTemplate = new AuthLetterTemplate()
            ...
            .pairContactName(DEFAULT_PAIR_CONTACT_NAME)
    ...
    public static AuthLetterTemplate createUpdatedEntity(EntityManager em) {
        AuthLetterTemplate authLetterTemplate = new AuthLetterTemplate()
            ...
            .pairContactName(UPDATED_PAIR_CONTACT_NAME)
    ...
    public void createAuthLetterTemplate() throws Exception {
        ...
        assertThat(testAuthLetterTemplate.getPairContactId()).isEqualTo(DEFAULT_PAIR_CONTACT_ID);
        assertThat(testAuthLetterTemplate.getPairContactName()).isEqualTo(DEFAULT_PAIR_CONTACT_NAME);
    ...
    public void checkPairContactIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = authLetterTemplateRepository.findAll().size();
        // set the field null
        authLetterTemplate.setPairContactId(null);
    ...
    @Test
    @Transactional
    public void checkPairContactNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = authLetterTemplateRepository.findAll().size();
        // set the field null
        authLetterTemplate.setPairContactName(null);
    ...
    public void getAllAuthLetterTemplates() throws Exception {
        ...
        restAuthLetterTemplateMockMvc.perform(get("/api/auth-letter-templates?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pairContactName").value(hasItem(DEFAULT_PAIR_CONTACT_NAME)))
    ...
    public void getAuthLetterTemplate() throws Exception {
        ...
        restAuthLetterTemplateMockMvc.perform(get("/api/auth-letter-templates/{id}", authLetterTemplate.getId()))
            ...
            .andExpect(jsonPath("$.pairContactName").value(DEFAULT_PAIR_CONTACT_NAME))
    ...
    public void updateAuthLetterTemplate() throws Exception {
        ...
        assertThat(testAuthLetterTemplate.getPairContactId()).isEqualTo(UPDATED_PAIR_CONTACT_ID);
        assertThat(testAuthLetterTemplate.getPairContactName()).isEqualTo(UPDATED_PAIR_CONTACT_NAME);
